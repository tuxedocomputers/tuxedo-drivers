...
#define UW_EC_REG_FAN_CTRL_STATUS_BIT_HAS_UW_FAN_CTRL	0x06

#define UW_EC_REG_CTGP_DB_ENABLE			0x0743
#define UW_EC_REG_CTGP_DB_ENABLE_BIT_GENERAL_ENABLE	0x00
#define UW_EC_REG_CTGP_DB_ENABLE_BIT_DB_ENABLE		0x01
#define UW_EC_REG_CTGP_DB_ENABLE_BIT_CTGP_ENABLE	0x02
#define UW_EC_REG_CTGP_DB_CTGP_OFFSET			0x0744
#define UW_EC_REG_CTGP_DB_MYSTERY_OFFSET		0x0745 // Probably unused but should be set anyway
